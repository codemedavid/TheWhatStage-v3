      ...
      <form action={updateActionPage} className="flex min-h-screen flex-col">
          ...
          <div className="flex items-end justify-between gap-4">
            <div className="min-w-0">
              ...
              <p className="mt-1 text-[13px] text-zinc-600">
                Pick which products show up, group them into collections, and
                set how leads land here.
              </p>
            </div>
            <a
              href={publicUrl}
        ...
        <main className="mx-auto w-full max-w-7xl flex-1 px-5 py-6">
          ...
          {/* Hidden inputs for the workflow fields the drawer manages —
              ...
              they exist regardless of drawer mount state. */}
        </main>
...
function SettingsDrawer({
  ...
  return (
    <>
      {/* Hidden render — keep the inputs always in the form so they submit */}
  ...
  return (
    <div className="space-y-6">
      ...
      <Field
        label="Description"
        optional
        help="Shown on the storefront below the title."
      >
        <textarea
          value={description}
          ...
          placeholder="Tell shoppers what this storefront is about."
        />
      </Field>
      ...
      <div className="rounded-lg border border-red-200 bg-red-50/50 p-4">
        ...
        <p className="mt-1 text-[12.5px] text-red-800/80">
          Deleting this storefront is permanent. Past orders are kept on lead
          records.
        </p>
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-0.5 text-[12.5px] text-zinc-500">
          Where leads land in your pipeline after they check out.
        </p>
        <div className="mt-3">
          <PipelineRulesEditor
      ...
      <Field
        ...
        optional
        help="Which Meta Conversions API event to fire on submission. Leave empty to use the default (InitiateCheckout / Purchase)."
      >
        <select
      ...
      <div className="rounded-lg border border-zinc-200 bg-zinc-50/50 p-4">
        <h4 className="text-[13px] font-semibold text-zinc-900">
          When should the bot send this storefront?
        </h4>
        <p className="mt-0.5 text-[12.5px] text-zinc-500">
        ...
        <div className="mt-3 space-y-3">
          ...
          <Field label="Trigger">
            <TriggerField
              ...
              rows={4}
              placeholder="Send when the lead asks about products, prices, or wants to order."
              className="w-full resize-y rounded-md border border-zinc-200 bg-white px-3 py-2 text-[13px] text-zinc-900 placeholder:text-zinc-400 focus:border-emerald-500 focus:outline-none focus:ring-1 focus:ring-emerald-500"
            />
          </Field>
        </div>
