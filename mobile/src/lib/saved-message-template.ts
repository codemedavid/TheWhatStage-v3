...
//
// NOTE: this module mirrors, deliberately and in full,
// src/lib/saved-messages/template.ts in the web app — the Expo app is a
// separate package that cannot import from it. Keep the two in sync.
